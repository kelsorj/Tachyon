...
#include	<p18Cxxx.H>
/*
// 8 MHZ internal clock settings
#define	TIMER_PERIOD_MS		1					// Period in milliseconds
#define	TIMER_FOSC			8000000L			// Frequency of the processor clock
#define	TIMER_PRESCALE		5					// The desired prescale 
// for 1ms intervals, prescale_values 8-256 all work, the most accurate seems to be <= 64 (+3ms at 1 sec interval)
*/

/*
// 16 MHZ internal clock settings
#define	TIMER_PERIOD_MS		1					// Period in milliseconds
#define	TIMER_FOSC			16000000L			// Frequency of the processor clock
#define	TIMER_PRESCALE		5					// The desired prescale 
// for 1ms intervals, prescale_values 32-256 all work
*/

/*
// 25 MHZ internal clock settings
#define	TIMER_PERIOD_MS		1					// Period in milliseconds
...
// 64 MHZ internal clock settings
#define	TIMER_PERIOD_MS		1					// Period in milliseconds
#define	TIMER_FOSC			64000000L			// Frequency of the processor clock
#define	TIMER_PRESCALE		5					// The desired prescale 
// for 1ms intervals, prescale_values 64-256 all work - 64 & 128 are exact
...
{	
	...
	TMR0L = 256L - ((TIMER_PERIOD_MS * TIMER_FOSC) / 1000L / 4 / TIMER_PRESCALE_VALUE);
