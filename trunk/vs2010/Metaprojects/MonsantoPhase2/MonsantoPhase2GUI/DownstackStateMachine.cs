...
namespace BioNex.CustomerGUIPlugins
{
    public class DownstackStateMachine : StateMachineWrapper2<DownstackStateMachine.State,DownstackStateMachine.Trigger>
    {
        ...
        public DownstackStateMachine( IError error_interface, MonsantoPhase2GUI plugin, string labware, bool called_from_diags)
        ...
        private void MoveStageToInternal()
        {
            ...
            if( !_platemover.ExecuteCommand( "movetointernalportraitteachpoint", null)) {
        ...
        private void TransferPlate()
        {
            try {
                ...
                _robot.TransferPlate(robot_name, location_name, (_platemover as DeviceInterface).Name, is_portrait ? "Stage, Portrait" : "Stage, Landscape", _labware, new MutableString());
