...
public class HiveClient implements HiveClientInterface
{
    ...
    private static String workset_example = "<?xml version='1.0' encoding='utf-8' ?>\n" +
        "<projects>\n" +
        "   <project name='a_project_name' destination ='Greiner 655101' method='protocolA' volume ='120uL'>\n" +
        "       <source type='Greiner 655101' bc='test_barcode'>\n" +
        "           <hitpick type ='control' source_row='A' source_column='1' destination_plate='1' destination_row='A' destination_column='1'/>\n" +
        "           <hitpick type ='sample' source_row='B' source_column='5' />\n" +
        "       </source>\n" +
        "   </project>\n" +
        "</projects>\n"
        ;
    ...
    public static void main(String[] args)
    {
        ...
        try{
            ...
            // NOTE : this test is not passable unless a plate with barcode 'test_barcode' exists in inventory, labware type must also match
            client.AddWorkSet(workset_example);
        }
        catch(Exception e){
