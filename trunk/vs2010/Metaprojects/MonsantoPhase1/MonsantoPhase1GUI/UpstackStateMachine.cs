...
namespace BioNex.CustomerGUIPlugins
{
    public class UpstackStateMachine : StateMachineWrapper2<UpstackStateMachine.State,UpstackStateMachine.Trigger>
    {
        ...
        public UpstackStateMachine( IError error_interface, MonsantoPhase1GUI plugin, string labware_name, string barcode, bool called_from_diags)
        ...
        private void TransferPlate()
        {
            try {
                ...
                MonsantoPhase1GUI.AvailableLocation location = null;
