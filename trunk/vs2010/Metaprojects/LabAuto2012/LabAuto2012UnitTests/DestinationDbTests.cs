...
namespace BioNex.CustomerGUIPlugins
{
    ...
    public class DestinationDbTests
    {
        ...
        {
            DestinationProcessing db = new DestinationProcessing( "destination_processing_db.s3db");
            db.SaveWork( "dest001", new BioNex.GemsRpc.TransferMap { source_barcode="source001", source_row=0, source_column=1, destination_row=2, destination_column=3, transfer_volume=4 });
            string dest_barcode;
